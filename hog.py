...
def pig_pass(player_score, opponent_score):
    ...
    False
    """
    _Δ =opponent_score - player_score
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    "*** YOUR CODE HERE ***"
    #牛魔酬宾终于对了wdnm改了两个半点
    def explain(score0, score1, last_score=last_score, running_high=running_high):
        if who ==0:
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    # 定义一个平均化的 pow 函数
def make_averaged(original_function, trials_count):
    """Return a function that averages the results of calling original_function."""
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score_all, opponent_score):
        return 0 
